...
--@localization(locale="itIT", namespace="STAT_SHORTS", format="lua_table", handle-unlocalized="ignore")@

Charplan.L.STAT_NAMES =
--@localization(locale="itIT", namespace="STATS", format="lua_table", handle-unlocalized="ignore")@
