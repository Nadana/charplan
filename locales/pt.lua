...
--@localization(locale="ptBR", namespace="STAT_SHORTS", format="lua_table", handle-unlocalized="ignore")@

Charplan.L.STAT_NAMES =
--@localization(locale="ptBR", namespace="STATS", format="lua_table", handle-unlocalized="ignore")@
