...
--@localization(locale="frFR", namespace="STAT_SHORTS", format="lua_table", handle-unlocalized="ignore")@

Charplan.L.STAT_NAMES =
--@localization(locale="frFR", namespace="STATS", format="lua_table", handle-unlocalized="ignore")@
